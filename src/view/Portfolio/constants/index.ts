import { workImagesProps } from '@/types/portfolio'

export const workNavs: Array<string> = ['Todos', 'Web', 'Clones']

export const workImages: Array<workImagesProps> = [
   {
      id: 1,
      img: '/images/empire-burger.png',
      name: 'Empire Burger',
      category: 'web',
   ...
   {
      id: 8,
      img: '/images/messenger-clone.png',
